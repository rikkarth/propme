...
```bash
curl -L -O https://github.com/rikkarth/propme/releases/latest/download/propme.jar
```

[Direct Download - propme.jar](https://github.com/rikkarth/propme/releases/latest/download/propme.jar)
